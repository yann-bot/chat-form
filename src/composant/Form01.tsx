        ...
        <div className="w-1/2 p-[80px]">
          ...
          <form className="space-y-4">
            <div className="flex space-x-4">
              <input type="text" placeholder="First name" className="w-1/2 border-b border-gray-300 p-3  pl-0 outline-none focus:border-gray-500" />
              <input type="text" placeholder="Last name" className="w-1/2 border-b border-gray-300 p-3  pl-0 outline-none focus:border-gray-500" />
            </div>
            <input type="text" placeholder="Job title" className="w-full border-b border-gray-300 p-3   pl-0 outline-none focus:border-gray-500" />
            <input type="email" placeholder="Work email" className="w-full border-b border-gray-300 p-3  pl-0 outline-none focus:border-gray-500" />
